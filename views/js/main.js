...
function updatePositions() {
    ...
    for (var e = document.querySelectorAll(".mover"), a = [], r = 0; r < e.length; r++) a.push(Math.sin(document.body.scrollTop / 1250 + r % 5));
    for (var r = 0; r < e.length; r++) e[r].style.left = e[r].basicLeft + 100 * a[r] + "px";
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noisy", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(e) {
        ...
        function n(e) {
            for (var a = document.querySelectorAll(".randomPizzaContainer"), n = r(a[0], e), i = a[0].offsetWidth + n + "px", t = 0; t < a.length; t++) a[t].style.width = i
        }
